...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SHUVCODE_CALLER", () => {
    process.env["SHUVCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SHUVCODE_CALLER", () => {
    process.env["SHUVCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SHUVCODE_CALLER", () => {
    process.env["SHUVCODE_CALLER"] = "unknown"
